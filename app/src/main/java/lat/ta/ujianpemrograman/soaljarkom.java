...
public class soaljarkom extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soaljarkom);
...
//        Section3 = db.getSoalDinamis(ListPacketActivity.paket, "3");
            ...
            public void onClick(View v)
            {
                if(inputUser.getText().toString().equals("")){
                    ...
                    dbh.execSQL("update tb_nilai " +
                            "set username = '" + username +"' where no='3'");
                    mulaiKuis();
                    dialog.dismiss();
                }
    ...
    private void tunjukanPertanyaan(int urutan_soal_soal, boolean review) {
        ...
        try {
            ...
            soal = Section3.get(urutan_soal_soal);
            ...
            if (urutan_soal_soal == (Section3.size() - 1)){
    ...
    public class CounterClass extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            tampilKotakAlert = new AlertDialog.Builder(soaljarkom.this).create();
            ...
            tampilKotakAlert.setButton(AlertDialog.BUTTON_NEUTRAL, "Yes",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            intent = new Intent(context, soaljarkom.class);
            ...
            tampilKotakAlert.setButton(AlertDialog.BUTTON_NEUTRAL, "Yes",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            intent.putExtra("nama_matkul", "Pemrograman Jaringan Komputer");
                            startActivity(intent);
    ...
    private OnClickListener klikBerikut = new OnClickListener() {
        public void onClick(View v) {
            aturJawaban_nya();
            urutanPertanyaan++;
            if (urutanPertanyaan >= Section3.size())
                urutanPertanyaan = Section3.size() - 1;
    ...
    private AlertDialog exitmenu() {
        AlertDialog builder = new AlertDialog.Builder(this)
                .setMessage("Apakah anda ingin keluar dari pemrograman Jaringan Komputer?")
                .setCancelable(false)//tidak bisa tekan tombol back
                //jika pilih yess
                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
