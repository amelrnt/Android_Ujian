...
public class soalweb extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soalweb);
...
//        section1 = db.getSoalDinamis(ListPacketActivity.paket, "1");
        ...
        //new GetSoal().execute();
        jawabanYgDiPilih = new int[section1.size()];
        java.util.Arrays.fill(jawabanYgDiPilih, -2);
        jawabanYgBenar = new int[section1.size()];
        ...
        btnOk.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                SQLiteDatabase dbh = db.getWritableDatabase();
                    ...
                    "set username = '" + username +"' where no='1'");
                mulaiKuis();
                dialog.dismiss();
                }
    ...
    private void tunjukanPertanyaan(int urutan_soal_soal, boolean review) {
        ...
        try {
            ...
            soal = section1.get(urutan_soal_soal);
            ...
            if (urutan_soal_soal == (section1.size() - 1)){
    ...
    public class CounterClass extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            tampilKotakAlert = new AlertDialog.Builder(soalweb.this).create();
            ...
            tampilKotakAlert.setButton(AlertDialog.BUTTON_NEUTRAL, "Lihat Nilai",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            intent.putExtra("nama_matkul", "Pemrograman Berbasis Website");
                            startActivity(intent);

                        }
                    });

//            tampilKotakAlert.setButton(AlertDialog.BUTTON_NEGATIVE, "Ulangi",
//
//                    new DialogInterface.OnClickListener() {
...
//                    });
    ...
    private OnClickListener klikBerikut = new OnClickListener() {
        public void onClick(View v) {
            aturJawaban_nya();
            urutanPertanyaan++;
            if (urutanPertanyaan >= section1.size())
                urutanPertanyaan = section1.size() - 1;
    ...
    private AlertDialog exitmenu() {
        AlertDialog builder = new AlertDialog.Builder(this)
                .setMessage("Apakah anda ingin keluar dari pemrograman soalweb?")
                .setCancelable(false)//tidak bisa tekan tombol back
                //jika pilih yess
                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
