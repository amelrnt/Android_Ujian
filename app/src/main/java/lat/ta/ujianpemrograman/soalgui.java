...
public class soalgui extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soalgui);
...
//        Section7 = db.getSoalDinamis(ListPacketActivity.paket, "7");
            ...
            public void onClick(View v)
            {
                if(inputUser.getText().toString().equals("")){
                    ...
                    dbh.execSQL("update tb_nilai " +
                            "set username = '" + username +"' where no='7'");
                    mulaiKuis();
                    dialog.dismiss();
                }
    ...
    private void tunjukanPertanyaan(int urutan_soal_soal, boolean review) {
        ...
        try {
            ...
            soal = Section7.get(urutan_soal_soal);
            ...
            if (urutan_soal_soal == (Section7.size() - 1)){
    ...
    public class CounterClass extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            tampilKotakAlert = new AlertDialog.Builder(soalgui.this).create();
            ...
            tampilKotakAlert.setButton(AlertDialog.BUTTON_NEUTRAL, "Yes",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            intent = new Intent(context, soalgui.class);
            ...
            tampilKotakAlert.setButton(AlertDialog.BUTTON_NEUTRAL, "Yes",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            intent.putExtra("nama_matkul", "Pemrograman Berbasis GUI");
                            startActivity(intent);
    ...
    private OnClickListener klikBerikut = new OnClickListener() {
        public void onClick(View v) {
            aturJawaban_nya();
            urutanPertanyaan++;
            if (urutanPertanyaan >= Section7.size())
                urutanPertanyaan = Section7.size() - 1;
    ...
    private AlertDialog exitmenu() {
        AlertDialog builder = new AlertDialog.Builder(this)
                .setMessage("Apakah anda ingin keluar dari pemrograman gui?")
                .setCancelable(false)//tidak bisa tekan tombol back
                //jika pilih yess
                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
