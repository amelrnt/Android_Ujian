...
public class soalalgoritma extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soalalgoritma);
...
//        Section4 = db.getSoalDinamis(ListPacketActivity.paket, "4");
            ...
            public void onClick(View v)
            {
                if(inputUser.getText().toString().equals("")){
                    ...
                    dbh.execSQL("update tb_nilai " +
                            "set username = '" + username +"' where no='4'");
                    mulaiKuis();
                    dialog.dismiss();
                }
    ...
    private void tunjukanPertanyaan(int urutan_soal_soal, boolean review) {
        ...
        try {
            ...
            soal = Section4.get(urutan_soal_soal);
            ...
            if (urutan_soal_soal == (Section4.size() - 1)){
    ...
    public class CounterClass extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            tampilKotakAlert = new AlertDialog.Builder(soalalgoritma.this).create();
            ...
            tampilKotakAlert.setButton(AlertDialog.BUTTON_NEUTRAL, "Yes",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            intent = new Intent(context, soalalgoritma.class);
            ...
            tampilKotakAlert.setButton(AlertDialog.BUTTON_NEUTRAL, "Lihat Nilai",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            intent.putExtra("nama_matkul", "Pemrograman Algoritma");
                            startActivity(intent);
...
/*            tampilKotakAlert.setButton(AlertDialog.BUTTON_NEGATIVE, "No",
    ...
    private OnClickListener klikBerikut = new OnClickListener() {
        public void onClick(View v) {
            aturJawaban_nya();
            urutanPertanyaan++;
            if (urutanPertanyaan >= Section4.size())
                urutanPertanyaan = Section4.size() - 1;
    ...
    private AlertDialog exitmenu() {
        AlertDialog builder = new AlertDialog.Builder(this)
                .setMessage("Apakah anda ingin keluar dari pemrograman soalalgoritma?")
                .setCancelable(false)//tidak bisa tekan tombol back
                //jika pilih yess
                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
