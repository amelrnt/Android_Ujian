...
public class soalbasisdata extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soalbasisdata);
...
//        Section5 = db.getSoalDinamis(ListPacketActivity.paket, "5");
            ...
            public void onClick(View v)
            {
                if(inputUser.getText().toString().equals("")){
                    ...
                    dbh.execSQL("update tb_nilai " +
                            "set username = '" + username +"' where no='5'");
                    mulaiKuis();
                    dialog.dismiss();
                }
    ...
    private void tunjukanPertanyaan(int urutan_soal_soal, boolean review) {
        ...
        try {
            ...
            soal = Section5.get(urutan_soal_soal);
            ...
            if (urutan_soal_soal == (Section5.size() - 1)){
    ...
    public class CounterClass extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            tampilKotakAlert = new AlertDialog.Builder(soalbasisdata.this).create();
            tampilKotakAlert.setMessage("Waktu Berakhir!" +
                    "\nAPakah anda ingin Mengerjakan soal lainya?");

            tampilKotakAlert.setButton(AlertDialog.BUTTON_NEUTRAL, "Yes",
                    new DialogInterface.OnClickListener() {

                        public void onClick(DialogInterface dialog, int which) {
                            intent = new Intent(context, soalbasisdata.class);
            ...
            tampilKotakAlert.setButton(AlertDialog.BUTTON_NEUTRAL, "Lihat Nilai",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            intent.putExtra("nama_matkul", "Pemrograman Basis Data");
                            startActivity(intent);
    ...
    private OnClickListener klikBerikut = new OnClickListener() {
        public void onClick(View v) {
            aturJawaban_nya();
            urutanPertanyaan++;
            if (urutanPertanyaan >= Section5.size())
                urutanPertanyaan = Section5.size() - 1;
    ...
    private void pasangLabelDanNomorUrut() {
        txtno.setText("Soal Nomor:" + (urutanPertanyaan + 1) + " - "
                + Section5.size());
    }
    ...
    private AlertDialog exitmenu() {
        AlertDialog builder = new AlertDialog.Builder(this)
                .setMessage("Apakah anda ingin keluar dari pemrograman basisdata?")
                .setCancelable(false)//tidak bisa tekan tombol back
                //jika pilih yess
                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
